...
<body>
    <?php
    $nimed = array("Emily","Gerson","Kati","Mari","Penny","Pam","Abigail","Robin","Mario");
    ...
    <?php
        $firmad = array("Kimia","Mynte","Voomm","Twiyo","Layo","Talane","Tagchat","Quaxo","Voonyx","Kwilith","Eidel","Eadel","Jaloo","Oyope","Jamia");
